...
export class Ansi {
	...
	static blackBackground(text: string) {
		return Ansi.apply(text, ANSI.bg.black);
	}
	...
	static redBackground(text: string) {
		return Ansi.apply(text, ANSI.bg.red);
	}
	...
	static greenBackground(text: string) {
		return Ansi.apply(text, ANSI.bg.green);
	}
	...
	static yellowBackground(text: string) {
		return Ansi.apply(text, ANSI.bg.yellow);
	}
	...
	static blueBackground(text: string) {
		return Ansi.apply(text, ANSI.bg.blue);
	}
	...
	static magentaBackground(text: string) {
		return Ansi.apply(text, ANSI.bg.magenta);
	}
	...
	static cyanBackground(text: string) {
		return Ansi.apply(text, ANSI.bg.cyan);
	}
	...
	static whiteBackground(text: string) {
		return Ansi.apply(text, ANSI.bg.white);
	}
	...
	static italic(text: string) {
		return Ansi.apply(text, ANSI.decoration.italic);
	}
	...
	static underline(text: string) {
		return Ansi.apply(text, ANSI.decoration.underline);
	}
	...
	static invert(text: string) {
		return Ansi.apply(text, ANSI.decoration.invert);
	}
	...
	static strike(text: string) {
		return Ansi.apply(text, ANSI.decoration.strike);
	}
